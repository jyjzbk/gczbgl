...
class PermissionService
{
    ...
    public function getAllPermissions(): array
    {
        return [
            ...
            // 基础数据管理权限
            'basic.subject.view',
            'basic.subject.create',
            'basic.subject.edit',
            'basic.subject.delete',
            ...
            'basic.textbook_version.create',
            'basic.textbook_version.edit',
            'basic.textbook_version.delete',
            'basic.textbook_version.batch_status',
            'basic.textbook_version.sort',
            'basic.textbook_chapter.view',
            'basic.textbook_chapter.tree',
            'basic.textbook_chapter.create',
            'basic.textbook_chapter.edit',
            'basic.textbook_chapter.delete',
        ];
    }
